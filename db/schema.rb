...
ActiveRecord::Schema.define(version: 20140726001009) do
  ...
  create_table "new_biosensors", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "specificity"
    t.string   "sensor_target_type"
    ...
    t.string   "pi_name"
    t.string   "sequence"
    t.string   "addgene_url",        limit: 2083
  end
